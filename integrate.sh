...
#(./simulate.sh -s main -p $2.ept -k 1)
...
#src=$pwd."/heptagon/$2_c"
#cp "$src/$2_types.c" "$dest_src/$2_types.cpp"
#cp "$src/$2_types.h" "$dest_src/$2_types.h"
#cp "$src/$2.c" "$dest_src/$2.cpp"
#cp "$src/$2.h" "$dest_src/$2.h"
